...
var StickyNav = function (_Component) {
	...
	_createClass(StickyNav, [{
		key: 'init',
		value: function init() {
			_scrollState2.default.subscribe(EVENT_SCROLL_FRAME, this.onStateChanged);
		...
		value: function destroy() {
			this.show();
			_scrollState2.default.unsubscribe(EVENT_SCROLL_FRAME, this.onStateChanged);
